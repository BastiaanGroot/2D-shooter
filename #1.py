...
bg = pygame.image.load('bg-desert.jpg')
char = pygame.image.load('standing.png')

clock = pygame.time.Clock()

bulletSound = pygame.mixer.Sound("shooting.wav")
hitSound = pygame.mixer.Sound("Underattack.wav")
deathSound = pygame.mixer.Sound("death-sound.wav")
music = pygame.mixer.music.load("7th realm.mp3")
...
class player(object):
    ...
    def hit(self):
        ...
        win.blit(text, (150 - (text.get_width()/2),10))
...
man = player(800, 365, 64, 64)
enemy = enemy(100, 370, 64,64, 500)
shootLoop = 0
bullets = []
run = True
while run:
